...
## Resultados V3 (202403)

Tras probar el modelo completo, se observa que el almacenamiento no responde bien para los datos 20231030 usando el caudal corregido para $q_{ts,src}/q_{hx,s}$ (ver [Resultados intercambiador](heat_exchanger.md#Resultados)). Esto probablemente se deba a que se calibró con un caudal que ya estaba siendo subestimado con los datos (10 de julio, limpieza se realizó 27 de Abril). 


También, es que no es normal esos cambios tan bruscos de temperatura en el almacenamiento térmico no?
