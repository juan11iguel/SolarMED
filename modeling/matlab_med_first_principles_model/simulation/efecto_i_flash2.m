function Fi = efecto_i_flash(x, ef, Uef)
    ...
    Mdest_in = ef.Mdest_in;
    Tdest_in = ef.Tdest_in;
    ...
    Fi(11) = Mdest_in - x(12) - x(11);     % Mdest = Mdest_in - Mdest_f
    Fi(12) = x(11)*cp_dest*(Tdest_in - x(13))/deltaHTvi - x(12); % Mdest_f = Mdest*Cp*(Tdest_in-Tdest)/deltaHTv
    Fi(13) = x(4) + NEA(x(13), Tdest_in, x(4)) - x(13);    % Tdest = Tv + NEA
    Fi(14) = x(13) - deltaHdest/cpSatLiqTW(x(13)) - x(14); % Tdest_out = Tdest - AHdest/Cp
