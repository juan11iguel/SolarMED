...
from . import inverse_heat_generation_and_storage_subproblem as model

# Should Tsf_out be also an output? To account for the fact that the obtained
# qsf values might not produce exactly the desired Tsf_out
out_mod_var_ids: list[str | list[str]] = ["Tsf_in", "Tsf_out", "qsf", "Tts_h_in", Th_labels, Tc_labels]
out_var_ids: list[str] = ["Tsf_in", "Tsf_out", "qsf", "Tts_h_in", *Th_labels, *Tc_labels]
