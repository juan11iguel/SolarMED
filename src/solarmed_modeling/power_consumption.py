...
actuator_coefficients = {
    ...
    # MED
    'med_brine_pump':      [0.010371467694486103, -0.025160600483389525, 0.03393870518526908], # m³/h -> kW [a sabé]
    'med_feed_pump':       [0.7035299527191431, -0.09466303549610014, 0.019077706335712326],   # m³/h -> kW [a sabé]
    'med_distillate_pump': [4.149635559273511, -3.6572156762250954, 0.9484207971761789],       # m³/h -> kW [a sabé]
    'med_cooling_pump':    [5.2178993694785625, -0.9238542100009888, 0.056680794931454774],    # m³/h -> kW [a sabé]
    'med_heatsource_pump': [0.031175213554380448, -0.01857544733009508, 0.0013320144040346285],# m³/h -> kW [a sabé]

    # Thermal storage
    'ts_src_pump': [0.04883341, -0.00695794, 0.01049481], # m³/h -> kW [20240925 aquasol-librescada]
    'FTSF001_calibration': [-0.0003028263249430021, 0.1237842280794974, -0.9609378680243738], # % -> m³/h

    # Solar field
    'sf_pump': [-8.47935428e-02, 2.29091363e-02, -8.72483421e-04, 1.29582523e-05], # m³/h -> kW [20240925-20240927 aquasol-librescada]
}
