...
import models_psa_temp as models_psa
...
def generate_env_variables(base_data_path, sample_period=pd.Timedelta(days=9), sample_rate:int=30, visualize_result=True, variables:list=None) -> pd.DataFrame:
